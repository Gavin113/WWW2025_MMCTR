...
class DIN(BaseModel):
    def __init__(self, 
        ...
        input_dim = feature_map.sum_emb_out_dim() + self.item_info_dim    # 384+256
    ...
    def forward(self, inputs):
        ...
        emb_list += [target_emb, pooling_emb]  # [feature_emb, target_emb, pooling_emb]  [(batch_size, 128), (batch_size, 256), (batch_size, 256)]
